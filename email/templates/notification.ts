          ...
          <tbody>
            <tr style="width:100%">
              <td>
                ...
                <h1 class="" style="color:rgb(0,0,0);font-size:24px;font-weight:400;text-align:center;padding:0px;margin-top:30px;margin-bottom:30px;margin-left:0px;margin-right:0px">You have a new notification</h1>
                <p style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(0,0,0)">Hello <!-- -->${to}<!-- -->,</p>
                <p style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(0,0,0)"><strong>${from}</strong> ${message} <strong>${postName}</strong>.</p>
                ...
                <p style="font-size:12px;line-height:24px;margin:16px 0;color:rgb(102,102,102)">You are receiving this because you have enabled notifications to be sent to you via email.</p>
              </td>
            </tr>
          </tbody>
        </table>
